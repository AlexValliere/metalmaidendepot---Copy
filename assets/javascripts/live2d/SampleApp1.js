...
function initL2dCanvas(canvasId)
{
    ...
    var Live2DExpressionsArray = ["Anger", "Engage", "Normal", "Happy", "Hit", "Proud", "Sad", "Shy", "Silent", "Smile", "Special"];
    Live2DExpressionsArray.forEach(function(expression) {
      btnChangeExpression = document.getElementById("btnExpression" + expression);
        btnChangeExpression.addEventListener("click", function(e) {
            thisRef.live2DMgr.models[0].setExpression(expression.toLowerCase());
        });
    });

    // var Live2DMotionsArray = ["idle", "action_off", "ready_attack", "action_on", "attack", "fly_attack", "fly_move", "engine", "fly_attack2"];
    var Live2DMotionsArray = ["idle", "attack", "ready_attack", "action_on", "action_off"];
    Live2DMotionsArray.forEach(function(motion) {
      btnChangeMotion = document.getElementById("btnMotion-" + motion);
        btnChangeMotion.addEventListener("click", function(e) {
            thisRef.live2DMgr.models[0].startRandomMotion(motion);
        });
    });
}
